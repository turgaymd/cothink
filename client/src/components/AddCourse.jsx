...
<input type="text" className="w-full form-input border border-gray-300 px-3 py-2 outline-none rounded-lg" placeholder="Kursun adını daxil edin" onChange={(e)=>setCourseTitle(e.target.value)}/>
</div>
<div>
                <label className="block title font-semibold text-gray-900 pb-2" htmlFor="title" >Dərs Başlığı</label>
                <input className="w-full form-input border border-gray-300 px-3 py-1.5 outline-none rounded-lg dark:bg-gray-700 dark:text-white dark:border-none"  placeholder="Dərsin başlığını daxil edin" onChange={(e)=>setLessonTitle(e.target.value)}/>
               </div>         
                    <div className="mb-4 mt-4">
 <label htmlFor="link" className="block title font-semibold text-gray-900 pb-2">Video Linki</label>
...
<div className="mb-4">
     <label htmlFor="file" className="block title font-semibold text-gray-900 pb-2">Fayllar</label>
...
<input  ref={fileInputRef} type="file"  className="sr-only" onChange={(e)=>setCourseFile(e.target.files[0].value)}/>
