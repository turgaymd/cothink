    ...
    return (
        <div className="research-form">
            ...
            <form className="mt-5" onSubmit={handlePost}>
                ...
                <textarea className="w-full form-input border border-gray-300 px-3 py-1.5 outline-none rounded-lg dark:bg-gray-700 dark:text-white dark:border-none" cols={5}  rows={3}   placeholder="Post başlığı əlavə edin"/>
               </div>
               <div>
 <label htmlFor="description" className="block title font-medium text-gray-900 pb-2">Qısa İzah / Post Haqqında</label>
<textarea type="text" className="w-full form-input border border-gray-300 px-3 py-1.5 outline-none rounded-lg" cols={5}  rows={3}  placeholder="Post haqqında 1–2 cümləlik açıqlama"/>
</div>
                </div>
                    <div className="mb-4">
